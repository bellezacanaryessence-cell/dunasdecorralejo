  ...
  head: () => ({
    meta: [
      ...
      { title: "Dunas de Corralejo | Guía de Corralejo, Fuerteventura" },
      {
        name: "description",
        content:
          "Guía de viaje de Corralejo y sus dunas: qué ver, dónde dormir, cómo llegar y consejos prácticos del norte de Fuerteventura.",
      },
      { property: "og:site_name", content: "Dunas de Corralejo" },
